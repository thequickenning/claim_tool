  ...
  <v-app id="app">
    <v-layout>
      <v-flex
        ...
        <v-card id="card">
          <v-card-media
            src="/img/logo-square-red-transparent-200x200.png"
            height="200px"
            :contain="true"/>
          <v-card-title primary-title>
            <div style="width: 100%;">
              <h3
                ...
                class="headline mb-0">Wyvern ERC20 Token Redemption</h3>
              <h2
                style="text-align: center; color: red;"
                class="headline mb-0"><em><br >Mainnet version. Snapshot of block 315000.</em></h2>
              <br ><br >
              <div v-if="selected">
                ...
                <v-form v-model="redeemValid">
                  ...
                  <div v-if="encoded">
                    ...
                    <v-btn
                      @click="send"
                      :disabled="txHash !== null">Send with Metamask</v-btn>
                    <a
                      v-if="txHash"
                      target="_blank"
                      :href="'https://etherscan.io/tx/' + txHash">View Transaction</a>
                  </div>
                  <v-text-field
                    v-if="encoded"
              ...
              <div v-if="disclaimer && !selected">
                ...
                <v-form
                  ...
                  <v-btn
                    @click="scan"
                    :disabled="!valid">Scan for UTXOs</v-btn>
                </v-form>
                <br >
                      ...
                      <v-card>
                        ...
                        <v-card-actions class="utxo-actions">
                          <v-btn
                            ...
                            @click="selected = utxo">Redeem UTXO</v-btn>
                        </v-card-actions>
                      </v-card>
                    </v-flex>
                  </v-layout>
          ...
          <v-card-actions>
            <v-btn
              ...
              color="black"
              style="color: #fff; margin: 0 auto;"
              @click="disclaimer = true">I understand, continue.</v-btn>
          </v-card-actions>
        </v-card>
      </v-flex>
    </v-layout>
...
const utxoMerkleTree = MerkleTree.fromJSON(require('./utxo-merkle-proof/data/merkleTree.json'));
